...
# *Maktaba*: Arabic Manuscripts from West African in English Translation
...
<Flex gap="3">
	<Box>
		### Browse Manuscripts
                ...
                View manuscript images alongside their English translations.
	...
	<Box>
		...
		Read our selection of contextual essays by leading scholars and translators.
	...
	<Box>
		...
		Meet the contributors, learn about the collections, and more.
